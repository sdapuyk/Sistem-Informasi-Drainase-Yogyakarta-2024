...
map.getView().fit([12279088.974126, -876453.225356, 12295491.021749, -867769.385181], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Lokasi Pembuatan Sumur Resapan Kota Yogyakarta Tahun 2024</h2>';
        return titleElement;
    })(),
